const siteOwnerName = "Tobias Wang";
...
const config = {
  ...
  meta: {
    ...
    defaultTitle: `Software Engineer | ${siteOwnerName}`,
  ...
  urls: {
    ...
    github: "https://github.com/tbking27171",
    twitter: "https://twitter.com/pobermeier87",
    websiteRepo: "https://github.com/tbking27171/pobermeier-portfolio-v3",
  },
};
